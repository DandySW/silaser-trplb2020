                ...
                <div class="widget-content nopadding">
                    <form class="form-horizontal" method="post" action="{{route('category.update',$categories->id)}}" name="basic_validate" id="basic_validate" novalidate="novalidate">
                        ...
                        <div class="control-group{{$errors->has('nama_kategori')?' has-error':''}}">
                            ...
                            <div class="controls">
                                <input type="text" name="nama_kategori" id="nama_kategori" value="{{$categories->nama_kategori}}" required>
                                <span class="text-danger" style="color: red;">{{$errors->first('nama_kategori')}}</span>
                            </div>
                        </div>
