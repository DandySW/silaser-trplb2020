...
<div class="container">
    <div class="row">
        ...
        {{-- Modal Struk --}}
        <div class="modal fade" id="modalStruk{{$order->id}}" tabindex="-1" aria-labelledby="modalStrukLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title" id="modalStrukLabel">Upload Bukti Pembayaran</h4>Tunggu hingga admin memverifikasi bukti pembayaran
                </div>
                <div class="modal-body">
                    <img src="{{url('/checkout',$order->struk)}}" alt="Belum ada bukti pembayaran">
                    <form action="{{route('uploadpembayaran',$order->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        {{method_field("PUT")}}
                        <input type="file" class="form-control" name="struk" id="struk" accept="image/png, image/jpeg, image/jpg" required>
